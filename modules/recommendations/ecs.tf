module "recommendations_task_definition" {
  ...
  task_exec_iam_role_name   = "${terraform.workspace}-ufb-rec-task-exec-role"
  task_exec_iam_role_policies = {
    exec_policy = aws_iam_policy.recommendations_ecs_task_exec_policy.arn
  }
}
